...
namespace Blauhaus.Graphql.Tests.Tests.HotChocolateTests.AuthenticatedUserMutationServerHandlerTests
{
    public class HandleAsyncTests : BaseGraphqlTest<AuthenticatedUserMutationServerHandler>
    {
        ...
        public async Task SHOULD_extract_headers_and_start_request_operation()
        {
            ...
            //Act
            await Sut.HandleAsync<TestServerCommand, TestServerPayload>(MockResolverContext.Object, CancellationToken.None);
        ...
        {
            //Arrange
            MockResolverContext.With_Service<IAuthenticatedUserCommandHandler<TestServerPayload, TestServerCommand>>(null);;
        ...
        public async Task IF_command_handler_succeeds_SHOULD_return_value()
        {
            ...
            //Act
            var result = await Sut.HandleAsync<TestServerCommand, TestServerPayload>(MockResolverContext.Object, CancellationToken.None);
