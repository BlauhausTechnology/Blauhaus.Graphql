...
namespace Blauhaus.Graphql.Tests.Tests.HotChocolateTests.VoidMutationServerHandlerTests
{
    public class HandleAsyncTests : BaseGraphqlTest<VoidMutationServerHandler>
    {
